...
class LoginActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val emaillayout = ObjectAnimator.ofFloat(binding.emailTextView, View.ALPHA, 1f).setDuration(500)
        ...
        AnimatorSet().apply {
            playSequentially(title,msg,emaillayout,email,password,passwordlayout,login)
            startDelay =500
