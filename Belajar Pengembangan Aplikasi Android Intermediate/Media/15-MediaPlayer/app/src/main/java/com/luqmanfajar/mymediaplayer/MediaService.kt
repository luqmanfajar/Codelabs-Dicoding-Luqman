package com.luqmanfajar.mymediaplayer
...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.luqmanfajar.mysound.mediaservice.create"
        const val ACTION_DESTROY = "com.luqmanfajar.mysound.mediaservice.destroy"
    ...
    internal class IncomingHandler(playerCallback: MediaPlayerCallback) : Handler(Looper.getMainLooper()){
        ...
        override fun handleMessage(msg: Message) {
            when (msg.what){
                ...
                STOP -> mediaPlayerCallbackWeakReference.get()?.onPlay()
